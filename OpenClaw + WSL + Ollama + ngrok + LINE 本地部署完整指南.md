...
前往 [https://dashboard.ngrok.com/signup](https://dashboard.ngrok.com/signup) 註冊免費帳號，取得 authtoken 後執行：
...
3. 點「**Verify**」確認連線正常（需要 gateway 和 ngrok 同時在跑）
4. 開啟「**Use webhook**」開關
...
**症狀：**
Config 已改成新模型，但 Web UI 下拉選單還顯示舊的名稱。
